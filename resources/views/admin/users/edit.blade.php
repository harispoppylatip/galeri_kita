    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="rounded-2xl border border-brown-light/30 bg-white/90 p-4 shadow-sm sm:p-6 md:p-8">
            <form action="{{ route('admin.users.update', $admin->id) }}" method="POST" class="space-y-5">
                ...
                {{-- Password --}}
                <div>
                    <label for="password" class="mb-2 block text-sm font-semibold text-brown-dark">
                        Password Baru
                        <span class="font-normal text-brown-medium">(kosongkan jika tidak ingin mengubah)</span>
                    </label>
                    <div class="relative">
                        <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-brown-medium/50">
